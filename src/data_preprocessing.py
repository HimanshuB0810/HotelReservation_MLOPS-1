...
class DataProcessor:
    ...
    def preprocess_data(self,df):
        try:
            ...
            skew_threshold = self.config['data_processing']['sknewness_threshold']
    ...
    def select_features(self,df):
        try:
            ...
            top_features_importances_df=feature_importance_df.sort_values(by='importance',ascending=False)

            num_of_features_to_select = self.config['data_processing']['no_of_features']
            top_10_features=top_features_importances_df['feature'].head(num_of_features_to_select).values
    ...
    def process(self):
        try:
            ...
            logger.error(f"Error during Preprocessing Pipeling step {e}")
            raise CustomException("Error while Preprocessing Pipeling",e)
